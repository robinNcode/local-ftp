    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-8">
      <div className="max-w-6xl mx-auto">
              ...
              <table className="w-full text-left block md:table">
                <thead className="bg-gray-50 hidden md:table-header-group">
                  <tr className="block md:table-row">
                    <th className="px-6 py-3 text-left block md:table-cell">
                      <button
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider block md:table-cell">
                      Name
                    </th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider block md:table-cell">
                      Size
                    ...
                    <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider block md:table-cell">
                      Actions
                    </th>
                  </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-200 block md:table-row-group">
                  {filteredFiles.map((file) => (
                    <tr key={file.name} className="hover:bg-gray-50 block md:table-row">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap block md:table-cell" data-label="Name">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 block md:table-cell" data-label="Size">
                        {formatSize(file.size)}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 block md:table-cell" data-label="Modified">
                        {formatDate(file.modifiedTime)}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium block md:table-cell" data-label="Actions">
                        <button
        ...
        <div className="mt-6 text-center text-gray-600 text-sm">
          <p>Share this URL with users on your network: <strong>http://192.168.0.103:6061</strong></p>
        </div>
      </div>
    </div>
  );
